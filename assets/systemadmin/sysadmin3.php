...
<head>
  ...
  <link rel="stylesheet" href="/assets/systemadmin/sysadmin2.css" />
</head>
<body>
<header>
  ...
  <h1>System Adminstrator</h1>
      <!-- <table id="systemadmin"> -->
          <div class="admin-pic">
              ...
              <div class="jobtitle"><h2>System Adminstrator</h2></div>
              <div class="greeting"><p>Welcome back, <span id= "username">Dave</span></p></div>
        </div>
