...
<head>
  ...
  <title>Guidance Exchange | Communities</title>
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link highlight-link nav-text px-4 active" href="communities.php">Communities</a>
          </li>
        </ul>
...
<body>
  ...
  <div class="communitiespics" style="background-image: url('img/biotech-pattern.png'); background-attachment: fixed; background-size: cover;">
    <div class="communitypics-grid">
      <a href=""><img src="img/IT_pic.jpeg" alt="IT picture" class="communitypic"></a>
      <a href=""><img src="img/stocks_pic.jpg" alt="stock picture" class="communitypic"></a>
      <a href=""><img src="img/marketing_pics.jpg" alt="marketing picture" class="communitypic"></a>
      <a href=""><img src="img/coins_pic.jpg" alt="coins picture" class="communitypic"></a>
      <a href=""><img src="img/personaldevelop_pic.jpeg" alt="development picture" class="communitypic"></a>
      <a href=""><img src="img/gambling_pic.jpg" alt="gambling picture" class="communitypic"></a>
    </div>
    <a class="btn main-button btn-long my-5" href="new_community.php<?php echo isset($_GET['profileID']) ? '?profileID=' . $_GET['profileID'] : ''; ?>" style="width: 180px;">Request Community</a>
  </div>
