...
<body>
  ...
  <div class="communitiespics" style="background-image: url('img/biotech-pattern.png'); background-attachment: fixed; background-size: cover; color: white;">
    <h1 class="mt-4 text-center"><?php echo $community['community_name']; ?></h1>
    <div class="w-75 d-flex justify-content-center">
      <h2 style="color: white; font-size: 1.5rem;"><?php echo $community['community_desc']; ?></h2>
    </div>
    <div class="row my-5">
      <div class="col text-center">
        <a class="btn main-button btn-long" href="new_discussion.php?community_id=<?php echo $communityId; ?>&profileID=<?php echo $userID; ?>">Start a Discussion</a>
      </div>
    </div>
  </div>
